...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)] p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-habi-primary/10 rounded-full blur-[120px] animate-pulse" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-habi-gold/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '2s' }} />
                ...
                <div className="enterprise-card p-8 lg:p-10 bg-[var(--bg-secondary)]/80 backdrop-blur-xl border border-[var(--border-color)]">
                    ...
                    <div className="mt-10 pt-8 border-t border-[var(--border-color)] text-center">
                        <p className="text-[var(--text-secondary)] text-sm font-medium">
                            ...
                            <Link to="/login" className="text-[var(--accent-gold)] hover:brightness-110 font-bold transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
